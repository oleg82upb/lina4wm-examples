...
C15v0: 
	...
	:: memory[v0] = dec; goto C15v00; 
	fi;
C14: goto C15v00; 
C16v0: 
	if 
	:: add = and + 1; goto C17v0; 
	:: memory[v0] = dec; goto C16v00; 
	fi;
C15v00: 
	if 
	:: and = v5 & 65535; goto C16v00; 
	:: memory[v0] = 0; goto C15; 
	fi;
C17v0: 
	if 
	:: cmp5 = (dec == shr); goto C18v0; 
	:: memory[v0] = dec; goto C17v00; 
	fi;
C16v00: 
	if 
	:: add = and + 1; goto C17v00; 
...
C18v0: 
	...
	:: memory[v0] = dec; goto C18v00; 
	fi;
C17v00: 
	if 
	:: cmp5 = (dec == shr); goto C18v00; 
	:: memory[v0] = 0; goto C17; 
	fi;
C16: add = and + 1; goto C17; 
C19v0: memory[v0] = dec; goto C19v00; 
C24v0: 
	if 
	:: goto C25v0; 
	:: memory[v0] = dec; goto C24v00; 
	fi;
C18v00: 
	if 
	::cmp5 -> goto C19v00; 
	::!cmp5 -> v8 = v4; goto C24v00; 
	:: memory[v0] = 0; goto C18; 
	fi;
C17: cmp5 = (dec == shr); goto C18; 
C19v00: memory[v0] = 0; goto C19; 
C25v0: 
	if 
	:: goto C26v0v8; 
	:: memory[v0] = dec; goto C25v00; 
	fi;
C24v00: 
	if 
	:: goto C25v00; 
...
C26v0v8: 
	...
	:: memory[v0] = dec; goto C26v00v8add; 
...
C27v0v8: 
	if 
	:: goto C28v0v8; 
	:: memory[v0] = dec; goto C27v00v8add; 
	:: memory[v8] = add; goto C27v0dec0; 
	fi;
C26v00v8add: 
	if 
	:: retval_0 = -1; goto C27v00v8add; 
	:: memory[v0] = 0; goto C26v8; 
	:: memory[v8] = add; goto C26v00; 
	fi;
C26v0: 
	if 
	:: retval_0 = -1; goto C27v0dec0; 
	:: memory[v0] = dec; goto C26v00; 
	fi;
C25: goto C26v8; 
C21: 
	if 
...
C28v0v8: 
	if 
	:: memory[v0] = dec; goto C28v00v8add; 
	:: memory[v8] = add; goto C28v0dec0; 
	fi;
C27v00v8add: 
	if 
	:: goto C28v00v8add; 
...
C28v0dec0: memory[v0] = dec; goto C28v00; 
C27v8: 
	if 
	:: goto C28v8; 
