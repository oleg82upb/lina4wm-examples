...
A03: getelementptr(1, v2, v1, idx); goto A04; 
A04: goto A05idx; 
A05idx: 
	if 
	:: inc = v1 + 1; goto A06idx; 
	:: memory[idx] = elem; goto A05; 
	fi;
A06idx: 
	if 
	:: goto A07idxv0; 
	:: memory[idx] = elem; goto A06; 
	fi;
A05: inc = v1 + 1; goto A06; 
A07idxv0: memory[idx] = elem; goto A07v0; 
A06: goto A07v0; 
...
B15: goto B16; 
B08: getelementptr(1, v4, shr, idx); goto B09; 
B16: returnvalue = retval_0; goto BEnd;
B09: v5 = memory[idx]; goto B10; 

B10: add5 = v1 + 65536; goto B11; 
B11: cas(v0, v1, add5, v6); goto B12; 
B12: v7 = (v6 == v1); goto B13; 
B13: v_ = (v7 -> v5 : -2); goto B14; 
B14: retval_0 = v_; goto B15; 
BEnd: skip; 
}


inline popBottom(returnvalue){
short v0, v1, cmp, retval_0, dec, v2, idx, v3, v4, v5, shr, cmp1, and, add, cmp5, v8, v6, v7, v_pre;
CStart: goto C00; 
...
C07v0: 
	if 
	:: getelementptr(1, v2, dec, idx); goto C08v0; 
	:: memory[v0] = dec; goto C07; 
	fi;
C06: v2 = memory[deq]; goto C07; 
C08v0: 
	if 
	:: v3 = memory[idx]; goto C09v0; 
	:: memory[v0] = dec; goto C08; 
	fi;
C07: getelementptr(1, v2, dec, idx); goto C08; 
C09v0: 
	if 
	:: v4 = memory[age]; goto C10v0; 
	:: memory[v0] = dec; goto C09; 
	fi;
C08: v3 = memory[idx]; goto C09; 
C10v0: 
	if 
