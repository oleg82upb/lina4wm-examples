...
entry:
  ...
  store i32 %2, i32* %arrayidx, align 4						;ub2
  %5 = load i32* %localBot, align 4
  %inc = add i32 %5, 1										
  store i32 %inc, i32* %localBot, align 4					;ub3
...
define i32 @dequeue() nounwind {			;poptop
entry:
...
define i32 @pop() nounwind {					; popBottom
entry:
  %retval = alloca i32, align 4
  %localBot = alloca i32, align 4
  %elem = alloca i32, align 4
...
if.end:                                           ; preds = %entry
  ...
  store i32 %4, i32* %5, align 4					;ob2
  %6 = load i32* %localBot, align 4
  %7 = load i32** @deq, align 4
  %arrayidx = getelementptr inbounds i32* %7, i32 %6
  %8 = load i32* %arrayidx, align 4					;ob3
  store i32 %8, i32* %elem, align 4
  %9 = load i32** @age, align 4
  %10 = load i32* %9, align 4						;ob4
...
if.end3:                                          ; preds = %if.end
  ...
  store i32 0, i32* %14, align 4					;ob5
...
if.then6:                                         ; preds = %if.end3
  ...
  %21 = cmpxchg i32* %18, i32 %19, i32 %20 seq_cst	;ob7
